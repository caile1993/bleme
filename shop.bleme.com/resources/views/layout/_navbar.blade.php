...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">商户管理中心</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{route('menu_categorys.create')}}">添加菜品分类</a></li>
                        <li><a href="{{route('menu_categorys.index')}}">菜品分类列表</a></li>
                    </ul>
                </li>
            </ul>
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">查看活动<span class="caret"></span></a>
                    <ul class="dropdown-menu">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{route('edit_pwd')}}">修改密码</a></li>
